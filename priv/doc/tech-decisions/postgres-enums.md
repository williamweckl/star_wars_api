...
Postgres enums also have some performance improvements compared to the use of single strings and using it also helps the data to be more legible since it is shown as a common string at queries and database tools.
